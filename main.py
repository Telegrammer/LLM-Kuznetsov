...
if __name__ == "__main__":
    ...
    model = Transformer(device, (1, 1, bag_size, token_dim, batch_size, batch_size), enc_head_count, dec_head_count).to(
        device)
